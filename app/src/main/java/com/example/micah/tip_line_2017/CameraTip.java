...
import com.example.micah.tip_line_2017.util.GMailSender;
import com.example.micah.tip_line_2017.util.XMLGenerator;
...
public class CameraTip extends LocationGetterActivity implements View.OnClickListener {
    ...
    private void showCancellationDialog() {
        ...
        helpBuilder.setNegativeButton("Cancel",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(CameraTip.this, MainActivity.class));
                    }
                });
